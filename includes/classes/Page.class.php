...
class Page
{
    ...
    public function __construct($data = null)
    {
        ...
        if (is_numeric($data)) {
            $this->original = get_post($data);
        }

        // Set ID
        if (is_a($this->original, 'WP_Post')) {
            $this->id = $this->original->ID;
        }

        // If ID is not null, get custom fields
        if (!empty($this->id) && function_exists('get_fields')) {
            $this->customFields = get_fields($this->id);
        }
     ...
     * @return string
     */
    public function sanitiseContent(string $content = ''): string
    {
     ...
     * @return     mixed
     */
    public function customField(string $key, $fallback = null)
    {
     ...
     * @return     mixed
     */
    public function gcf(string $key, $fallback = null)
    {
     ...
     * @return     boolean
     */
    public function hasFeatureImage(string $size = null): bool
    {
     ...
     * @return     string|null
     */
    public function getFeatureImage($size = 'full'):  ? string
    {
     ...
     * @return string|null
     */
    public function getSmallestFeatureImage() :  ? string
    {
     ...
     * @return void
     */
    private function findChildren() : void
    {
     ...
     * @return string
     */
    public function makeSnippet($numWords = 120, $elipsis = "..."): string
    {
